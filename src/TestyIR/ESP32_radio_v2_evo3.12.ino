...
//#include "Freenove_IR_Lib_for_ESP32.h"  // Pilot IR


#define softwareRev "v3.12"  // wersja oprogramowania
...
#define rcCmdVolumeUp 0x15
#define rcCmdVolumeDown 0x14
#define rcCmdBankUp 0x0B
#define rcCmdBankDown 0x0A
#define rcCmdStationUp 0x87
#define rcCmdStationDown 0x86
#define rcCmdKey0 0x00
#define rcCmdKey1 0x01
#define rcCmdKey2 0x02
...
void receiveIr()
{
  if (IrReceiver.decode()) 
  {
   ...
   if (IrReceiver.decodedIRData.address == 0xB9) 
   {
